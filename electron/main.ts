...
// Tray Icons
const defaultTrayIcon = getTrayIcon("openstudio-tray.png", 24, 24);
const recordingTrayIcon = getTrayIcon("rec-button.png", 24, 24);
...
function getTrayIcon(filename: string, width: number = 24, height: number = 24) {
	return nativeImage
...
app.whenReady().then(async () => {
	...
	registerIpcHandlers(
		...
		createWebcamPreviewWindowWrapper,
		() => webcamPreviewWindow,
