				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
					...
					>
						...
						{isSelected && <div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-white" />}
					</button>
				);
			})}
		</div>
