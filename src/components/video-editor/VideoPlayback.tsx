...
interface VideoPlaybackProps {
	...
	screenLayoutPreset?: import("./types").ScreenLayoutPreset;
				...
				{pixiReady && videoReady && (
					...
					>
						<div
							...
							className="absolute rounded-md border border-[#5078EA]/80 bg-[#5078EA]/20 shadow-[0_0_0_1px_rgba(80,120,234,0.35)]"
